...
// Direct URL to the uploaded original (no transformation params) — sidesteps
// Cloudinary's "first request generates the derived asset" cold-start that
// Gmail's image proxy sometimes hits as a 404 and then caches.
const LOGO_URL =
  (typeof process !== "undefined" && process.env && process.env.EMAIL_LOGO_URL) ||
  "https://res.cloudinary.com/dqi32bxkh/image/upload/laundry/email-icons/leaf-logo.png";
